...
public class Element extends Node implements edu.jhu.apl.patterns_class.dom.replacement.Element
{
	...
	public Element(String tagName)
	{
		...
		attributes	= new NamedNodeMap((edu.jhu.apl.patterns_class.dom.replacement.Document) document);
	}
	...
	//
	public org.w3c.dom.NamedNodeMap getAttributes()	{ return (org.w3c.dom.NamedNodeMap) attributes; }
...
class ValidChildren
{
	//String Vector Factory
	private java.util.Vector<String> stringVectorFactory()
	{
	...
	//Boolean Vector Factory
	private java.util.Vector<Boolean> booleanVectorFactory()
	{
	...
	private java.util.Vector<String>	validChildren		= stringVectorFactory();
	private java.util.Vector<Boolean>	childIsAttribute	= booleanVectorFactory();
